...
const kz = {
  ...
  // Телефонды SMS арқылы растау (firebase/phoneAuth.js)
  phoneVerifyTitle: "Телефонды растау",
  phoneVerifyIntro:
    "Нөміріңізге SMS арқылы 6 таңбалы код жібереміз. Кітап алмасқанда мүшелер сізбен осы нөмір арқылы байланысады.",
  phoneChangeIntro: "Жаңа нөміріңізді жазыңыз — оны да SMS арқылы растау қажет.",
  phoneCurrent: "Қазіргі нөмір",
  phoneSmsNote: "Нөмірді халықаралық форматта жазыңыз: +7 700 000 00 00",
  phoneSendCode: "Код жіберу",
  phoneCodeSentTitle: "Код жіберілді",
  phoneCodeLabel: "Кодтың таңбасы",
  phoneConfirmCode: "Растау",
  phoneChangeNumber: "Нөмірді өзгерту",
  phoneResend: "Кодты қайта жіберу",
  phoneResendIn: (sec) => `Қайта жіберу — ${sec} с`,
  phoneCodeMissing: "6 таңбалы кодты толық енгізіңіз",
  phoneCodeWrong: "Код қате. Тексеріп, қайта енгізіңіз.",
  phoneCodeExpired: "Кодтың мерзімі бітті. Жаңа код сұраңыз.",
  phoneTakenError: "Бұл нөмір басқа аккаунтқа тіркелген.",
  phoneAlreadyLinked: "Бұл нөмір аккаунтыңызға тіркелген.",
  phoneNeedsPassword: "Қауіпсіздік үшін құпия сөзіңізді енгізіңіз.",
  phoneTooManyRequests: "Тым көп әрекет жасалды. Біраз уақыттан кейін қайталаңыз.",
  phoneCaptchaFailed: "Тексеруден өту сәтсіз аяқталды. Қайта көріңіз.",
  phoneNotEnabled: "SMS арқылы растау әзірге қосылмаған.",
  ...
  phoneDevCode: "Код (тек әзірлеу режимі)",
...
const ru = {
  ...
  // Подтверждение телефона по SMS (firebase/phoneAuth.js)
  phoneVerifyTitle: "Подтверждение телефона",
  phoneVerifyIntro:
    "Отправим на ваш номер 6-значный код в SMS. По этому номеру участники свяжутся с вами при передаче книги.",
  phoneChangeIntro: "Введите новый номер — его тоже нужно подтвердить по SMS.",
  phoneCurrent: "Текущий номер",
  phoneSmsNote: "Номер в международном формате: +7 700 000 00 00",
  phoneSendCode: "Отправить код",
  phoneCodeSentTitle: "Код отправлен",
  phoneCodeLabel: "Символ кода",
  phoneConfirmCode: "Подтвердить",
  phoneChangeNumber: "Изменить номер",
  phoneResend: "Отправить код повторно",
  phoneResendIn: (sec) => `Повторно — через ${sec} с`,
  phoneCodeMissing: "Введите все 6 цифр кода",
  phoneCodeWrong: "Неверный код. Проверьте и введите ещё раз.",
  phoneCodeExpired: "Срок действия кода истёк. Запросите новый.",
  phoneTakenError: "Этот номер уже привязан к другому аккаунту.",
  phoneAlreadyLinked: "Этот номер уже привязан к вашему аккаунту.",
  phoneNeedsPassword: "Для безопасности введите пароль.",
  phoneTooManyRequests: "Слишком много попыток. Попробуйте позже.",
  phoneCaptchaFailed: "Проверка не пройдена. Попробуйте ещё раз.",
  phoneNotEnabled: "Подтверждение по SMS пока не включено.",
  ...
  phoneDevCode: "Код (только для разработки)",
...
const en = {
  ...
  // Proving a phone number by SMS (firebase/phoneAuth.js)
  phoneVerifyTitle: "Verify your phone",
  phoneVerifyIntro:
    "We'll text you a 6-digit code. This is the number members use to reach you when a book changes hands.",
  phoneChangeIntro: "Enter the new number — it has to be verified by SMS as well.",
  phoneCurrent: "Current number",
  phoneSmsNote: "Use the international format: +7 700 000 00 00",
  phoneSendCode: "Send the code",
  phoneCodeSentTitle: "Code sent",
  phoneCodeLabel: "Code digit",
  phoneConfirmCode: "Verify",
  phoneChangeNumber: "Use a different number",
  phoneResend: "Send it again",
  phoneResendIn: (sec) => `Send again in ${sec}s`,
  phoneCodeMissing: "Enter all 6 digits",
  phoneCodeWrong: "Wrong code. Check it and try again.",
  phoneCodeExpired: "That code has expired. Ask for a new one.",
  phoneTakenError: "That number belongs to another account.",
  phoneAlreadyLinked: "That number is already on your account.",
  phoneNeedsPassword: "Enter your password to confirm this change.",
  phoneTooManyRequests: "Too many attempts. Try again later.",
  phoneCaptchaFailed: "The check did not pass. Try again.",
  phoneNotEnabled: "SMS verification is not switched on yet.",
  ...
  phoneDevCode: "Code (development only)",
